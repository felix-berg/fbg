...
template <typename Col>
void fbg::compute_circle_stroke(Frame<Col> & frame, int cx, int cy, int r, const Col & color, int sw) {
	int x = r;
	int y = 0;
...
*/
template <typename Col>
void fbg::compute_circle_fill(Frame<Col> & frame, int cx, int cy, int r, const Col & color) {
	int x = r;
	int y = 0;
	int D = 3 - 2 * r;

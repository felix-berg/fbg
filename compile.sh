...
echo "Compiling..."
g++-11 -std=c++20  *.cpp Graphics_Lib/*.cpp Graphics_Lib/Shapes/*.cpp Graphics_Lib/Shapes/drawing_algorithms/*.cpp Graphics_Lib/Shapes/BMP/*.cpp -lSDL2 -mavx2 -pthread -O3 -H
